      ...
      {user && user.gender === 'male' && (
        <div className={styles.filters}>
          <div className={styles.filterGroup}>
            <label htmlFor="minAgeFilter">Age from:</label>
            <input
              min={18}
              type="number"
              id="minAgeFilter"
          ...
          <div className={styles.filterGroup}>
            <label htmlFor="maxAgeFilter">Age to:</label>
            <input
              min={18}
              max={100}
              type="number"
          ...
          <div className={styles.filterGroup}>
            <label htmlFor="minHeightFilter">Height from:</label>
            <input
              step={5}
              type="number"
              id="minHeightFilter"
          ...
          <div className={styles.filterGroup}>
            <label htmlFor="maxWeightFilter">Weight to:</label>
            <input
              step={5}
              type="number"
              id="maxWeightFilter"
