    ...
    <section className={styles.wrapper}>
      ...
      <div className={styles.metaBlock}>
          ...
          <ul className={styles.metaNumbers}>
            ...
            <li className={styles.metaItem}>
              ...
              {isEditing ? (
                ...
                >
                  <option value="Moscow">--City*</option>
        ...
        {isEditing && (
          <>
            {user?.user?.isPaidService ? (
              <p className={styles.warning_green}>You can change power</p>
            ) : (
              <p className={styles.warning}>In order to change power you have to pay</p>
            )}
          </>
        )}
